...
import { DailyOverviewTV, GlowBall, Neutron, Newspaper } from '../../../../assets'
            ...
            >
                ...
                <div className='pre-title-submenu'>
                    ...
                    >
                        ...
                        <MenuItem onClick={() => handleClickSubMenu("/article/dashboard", 1)} className={`custom-menu-item`} style={{fontWeight: window.location.pathname.indexOf("/article/dashboard") != -1 ? 700:'normal'}}><span className='sidemenu-label-submenu'>Article</span></MenuItem>
                    ...
                    <SubMenu className='submenu-custom' label="List" defaultOpen ={window.location.pathname.indexOf("/list") != -1 ? true : false} 
                          icon={svgCustom('repair',undefined,30,30,undefined)}
                    >
                        <MenuItem onClick={() => handleClickSubMenu("/article/list", 3)}    style={{fontWeight: window.location.pathname.indexOf("/article/list") != -1 ? 700:'normal'}}><span className='sidemenu-label-submenu'>Article</span></MenuItem>
