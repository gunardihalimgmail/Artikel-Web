...
import { AppRegistration, Architecture, Article, Assignment, BarChart, CandlestickChart, CellTower, Collections, ConnectedTv, Dashboard, DirectionsCar, DomainAdd, Engineering, HighlightAlt, InsertChart, Inventory, LocalGasStation, MusicVideoOutlined, Newspaper, PlayCircle, QueryStats, Settings, StackedBarChart, VideoStable } from '@mui/icons-material'
                                ...
                                <h3 className='ppe-dashtangki-page-title'>
                                      ...
                                      <span className='ppe-bg-gradient-success ppe-dashtangki-mdi-span ms-3'>
                                          ...
                                          }
                                          {
                                            titleIcon == 'Dashboard' && 
                                            (
                                              <Dashboard sx={{fontSize: '30px', color:'white'}}/>
                                            )
                                          }
                                          {
                                            titleIcon == 'Detail' && 
                                            (
                                              <Newspaper sx={{fontSize: '30px', color:'white'}}/>
                                            )
                                          }
                                      </span>
