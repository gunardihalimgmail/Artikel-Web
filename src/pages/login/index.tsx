...
import {IoTLogo, Newspaper} from '../../assets'
...
const Login = () => {
  ...
  const [disabledProp, setDisabledProp] = useState(false);
    ...
    obj_valDefault = {...obj_valDefault, 'username':'admin', 'password':'admin'}
	...
	const handleFinalSubmit = (form:any) => {
      ...
      if (valInput?.['username'].toString().trim() !== ''
      && valInput?.['password'].toString().trim() !== '')
      {
		...
		<div>
			<div className='loginpage-wrapper'>  
              ...
              <div className='login-side-right-logo'>
                  <img className='logo-class' src={Newspaper} width={100}/>
              </div>
